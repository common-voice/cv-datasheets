...
for Atayal (`tay`). The dataset contains 7857 clips representing 12.24 hours of recorded
speech (11.6 hours validated) from 18 speakers.
...
### Community links
* [Common Voice translators on Pontoon](https://pontoon.mozilla.org/tay/common-voice/contributors/)
...
* [Write](https://commonvoice.mozilla.org/tay/write)
* [Listen](https://commonvoice.mozilla.org/tay/listen)
* [Review](https://commonvoice.mozilla.org/tay/review)
