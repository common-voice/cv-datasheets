# *[Cajatambo Qichwa]* &mdash; Cajatambo Quechua (`qvl`)
This datasheet is for version 24.0 of the the Mozilla Common Voice *Scripted Speech* dataset 
for Quechua Cajatambo (`qvl`). The dataset contains 9100 clips representing 10.06 hours of recorded
speech (10.04 hours validated) from 19 speakers.
