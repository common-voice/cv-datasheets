...
for Mina (`gej`). The dataset contains 16774 clips representing 12 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 19.43% are included in the splits.
...
The text corpus contains `3187` sentences, of which `3188` are validated, `-1` are invalidated and `0` are reported.
