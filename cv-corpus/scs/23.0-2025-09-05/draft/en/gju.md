...
for Gujari (`gju`). The dataset contains 11741 clips representing 11 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 34.59% are included in the splits.
...
The text corpus contains `3854` sentences, of which `3852` are validated, `2` are invalidated and `0` are reported.
