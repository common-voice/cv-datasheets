...
para Teutila Cuicatec (cut). El conjunto de datos contiene 5616 clips reprentando 11 horas de grabaciones (11 horas
...
Las particiones de datos oficiales para el modelado de esta lengua son las siguientes. De los clips validados, 18.12% están incluidos en las particiones.
...
El corpus textual contiene `995` oraciones, de las cuales `994` están validadas, `1` están invalidadas y `0` son reportadas.
...
* [Hablar](https://commonvoice.mozilla.org/cut/speak)
* [Escribir](https://commonvoice.mozilla.org/cut/write)
* [Escuchar](https://commonvoice.mozilla.org/cut/listen)
* [Revisar](https://commonvoice.mozilla.org/cut/review)
