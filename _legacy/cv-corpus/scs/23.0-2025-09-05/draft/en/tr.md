...
for Turkish (`tr`). The dataset contains 125487 clips representing 134 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 53.17% are included in the splits.
...
The text corpus contains `413873` sentences, of which `410402` are validated, `3471` are invalidated and `479` are reported.
...
* [Speak](https://commonvoice.mozilla.org/tr/speak)
* [Write](https://commonvoice.mozilla.org/tr/write)
* [Listen](https://commonvoice.mozilla.org/tr/listen)
* [Review](https://commonvoice.mozilla.org/tr/review)
