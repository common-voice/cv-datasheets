...
for Seediq (`trv`). The dataset contains 6490 clips representing 10.11 hours of recorded
speech (9.95 hours validated) from 10 speakers.
...
### Community links
* [Common Voice translators on Pontoon](https://pontoon.mozilla.org/trv/common-voice/contributors/)
...
* [Write](https://commonvoice.mozilla.org/trv/write)
* [Listen](https://commonvoice.mozilla.org/trv/listen)
* [Review](https://commonvoice.mozilla.org/trv/review)
