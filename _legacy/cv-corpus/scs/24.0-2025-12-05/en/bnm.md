...
for Batanga (`bnm`). The dataset contains 7974 clips representing 16.8 hours of recorded
speech (16.17 hours validated) from 21 speakers.
...
1. Ó yadi ya sukulu, ihándini behado mʼbɔbɔtɔ
2. Taba ya mwadi ehávɛkwɛ nʼkodi múyava
3. Ovévé voji bwámu, timbaha etungi
4. Bato bɔkɔ́ bahátɔndɔ ija mehɔndɔ myá nʼtiba
5. Inɔngindi jɛtɔ já náh basiyo bahipɔse pɛhɛ

*Automatic random samples*

```
 Ivɛndi malinda mámɛ mɛ́hɛ́pi ó ba mesɔji
Vyaha ó ndabo vɛngɛ na kolo, tombete vakɛ na kolo.
Na mɔ́ na nɔngɔ́hɔ mahɔni mámu na dikúkú 
Nyuwɛ ya ipala diwedi da moto endi nyuwɛ ya kɔbɔlɔ o mepawo me kwedi
Eyɔ́ endi na wéh wáhá na ehevo.
```
<!-- {{SENTENCES_SAMPLE}} -->
...
### Community links
* [Common Voice translators on Pontoon](https://pontoon.mozilla.org/bnm/common-voice/contributors/)
...
### Contribute
https://commonvoice.mozilla.org/bnm/speak
<!-- {{CONTRIBUTE_LINKS_LIST}} -->
<!-- Here you can include links for how to contribute to the dataset -->

## Acknowledgements
The compilation of this dataset occured during data camp organized in Yaoundé (Cameroon) in September-October 2024. Two main contributors were involved in the localization of the MCV interface for Batanga, gathering of the sentence prompts, reading sentence prompts, and validating recordings. They are :
- Jean-Mathieu Etoma
- Paul Mpoulet
...
### Datasheet authors
Emmanuel Ngue Um <ngueum@gmail.com>,  Jean-Mathieu Etoma <etomajmatt@gmail.com>, Paul Mpoulet <paulmpoulet2024@gmail.com>
