# *მარგალური* &mdash; Mingrelian (`xmf`)
...
for Mingrelian (`xmf`). The dataset contains 7371 clips representing 12.66 hours of recorded
speech (11.6 hours validated) from 87 speakers.
