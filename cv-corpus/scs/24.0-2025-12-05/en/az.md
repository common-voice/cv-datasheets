...
for Azerbaijani (`az`). The dataset contains 1009 clips representing 1.52 hours of recorded
speech (0.62 hours validated) from 45 speakers.
...
## Text corpus
The text corpus contains `95011` sentences, of which `93161` are validated, `1850` are invalidated and `5` are reported.
...
```
Fərhad Əsgərovun xarici ölkələrdə də bədii əsərləri çap edilmişdir.
Anası onun atasının öldüyünü bildirmişdir.
Bu ələ keçirilən fransız ticarət gəmisi idi.
Ancaq model çox müvəffəqiyyətli olmadı.
Saleh Qafarov hərbi təhsil alıb.
```
<!-- {{SENTENCES_SAMPLE}} -->
