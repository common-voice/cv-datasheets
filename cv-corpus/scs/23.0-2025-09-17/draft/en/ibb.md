...
for Ibibio (`ibb`). The dataset contains 7461 clips representing 28 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 33.05% are included in the splits.
...
The text corpus contains `1030` sentences, of which `1031` are validated, `-1` are invalidated and `0` are reported.
...
* [Speak](https://commonvoice.mozilla.org/ibb/speak)
* [Write](https://commonvoice.mozilla.org/ibb/write)
* [Listen](https://commonvoice.mozilla.org/ibb/listen)
* [Review](https://commonvoice.mozilla.org/ibb/review)
