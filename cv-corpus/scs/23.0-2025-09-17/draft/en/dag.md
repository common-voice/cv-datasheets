...
for Dagbani (`dag`). The dataset contains 20734 clips representing 13 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 14.86% are included in the splits.
...
The text corpus contains `20477` sentences, of which `5003` are validated, `15474` are invalidated and `0` are reported.
...
* [Speak](https://commonvoice.mozilla.org/dag/speak)
* [Write](https://commonvoice.mozilla.org/dag/write)
* [Listen](https://commonvoice.mozilla.org/dag/listen)
* [Review](https://commonvoice.mozilla.org/dag/review)
