# *Pasku Qichwa* &mdash; Pasco Santa Ana de Tusi Quechua (`qxt`)
This datasheet is for version 24.0 of the the Mozilla Common Voice *Scripted Speech* dataset 
for Quechua Pasco Santa Ana de Tusi (`qxt`). The dataset contains 11128 clips representing 13.26 hours of recorded
speech (10.3 hours validated) from 16 speakers.
