...
for Dameli (`dml`). The dataset contains 6487 clips representing 11 hours of recorded
...
The official data splits for modelling this language are as follows. Of the validated clips, 80.41% are included in the splits.
...
The text corpus contains `6346` sentences, of which `5670` are validated, `676` are invalidated and `0` are reported.
...
* [Speak](https://commonvoice.mozilla.org/dml/speak)
* [Write](https://commonvoice.mozilla.org/dml/write)
* [Listen](https://commonvoice.mozilla.org/dml/listen)
* [Review](https://commonvoice.mozilla.org/dml/review)
