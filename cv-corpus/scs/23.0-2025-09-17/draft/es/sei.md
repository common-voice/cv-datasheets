...
para Seri (sei). El conjunto de datos contiene 8260 clips reprentando 11 horas de grabaciones (11 horas
...
Las particiones de datos oficiales para el modelado de esta lengua son las siguientes. De los clips validados, 20.17% están incluidos en las particiones.
...
El corpus textual contiene `1614` oraciones, de las cuales `1615` están validadas, `-1` están invalidadas y `0` son reportadas.
...
* [Hablar](https://commonvoice.mozilla.org/sei/speak)
* [Escribir](https://commonvoice.mozilla.org/sei/write)
* [Escuchar](https://commonvoice.mozilla.org/sei/listen)
* [Revisar](https://commonvoice.mozilla.org/sei/review)
