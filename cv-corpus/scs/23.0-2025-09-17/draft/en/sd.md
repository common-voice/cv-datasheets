...
for Sindhi (`sd`). The dataset contains 30163 clips representing 35 hours of recorded
...
The text corpus contains `13419` sentences, of which `13346` are validated, `73` are invalidated and `6` are reported.
...
* [Speak](https://commonvoice.mozilla.org/sd/speak)
* [Write](https://commonvoice.mozilla.org/sd/write)
* [Listen](https://commonvoice.mozilla.org/sd/listen)
* [Review](https://commonvoice.mozilla.org/sd/review)
